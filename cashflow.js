...
export default function App() {
  ...
  // --- UI COMPONENTS ---
  const InputGroup = ({ label, name, value, suffix, prefix, step = "1", hasSlider, sliderMin = "0", sliderMax = "100", sliderStep = "1" }) => (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                  <InputGroup label="Purchase Price" name="purchasePrice" value={inputs.purchasePrice} prefix="$" step="5000" hasSlider sliderMin="50000" sliderMax="5000000" sliderStep="1000" />
                  <InputGroup label="Down Payment" name="downPaymentPercent" value={inputs.downPaymentPercent} suffix="%" step="5" hasSlider sliderStep="5" />
                  <InputGroup label="Interest Rate" name="interestRate" value={inputs.interestRate} suffix="%" step="0.1" hasSlider sliderMin="0" sliderMax="15" sliderStep="0.01" />
                  <InputGroup label="Gross Monthly Rent" name="monthlyRent" value={inputs.monthlyRent} prefix="$" step="50" hasSlider sliderMin="0" sliderMax="20000" sliderStep="10" />
                  <InputGroup label="Property Tax Rate" name="propertyTaxPercent" value={inputs.propertyTaxPercent} suffix="%" step="0.1" hasSlider sliderMin="0" sliderMax="5" sliderStep="0.01" />
                  <InputGroup label="Insurance (Annual)" name="insuranceAnnual" value={inputs.insuranceAnnual} prefix="$" step="50" hasSlider sliderMin="0" sliderMax="10000" sliderStep="10" />
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-6 space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                      <InputGroup label="Loan Term" name="loanTermYears" value={inputs.loanTermYears} suffix="Yrs" step="5" />
                      <InputGroup label="Closing Costs" name="closingCosts" value={inputs.closingCosts} prefix="$" step="500" />
                      <InputGroup label="Repair/Rehab Costs" name="repairCosts" value={inputs.repairCosts} prefix="$" step="500" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                      <InputGroup label="Other Monthly Income" name="otherIncome" value={inputs.otherIncome} prefix="$" step="50" />
                      <InputGroup label="HOA Fees (Monthly)" name="hoaMonthly" value={inputs.hoaMonthly} prefix="$" step="10" />
                      <InputGroup label="Utilities (Monthly)" name="utilitiesMonthly" value={inputs.utilitiesMonthly} prefix="$" step="10" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                      <InputGroup label="Vacancy Rate" name="vacancyPercent" value={inputs.vacancyPercent} suffix="%" step="1" />
                      <InputGroup label="Maintenance & Repairs" name="maintenancePercent" value={inputs.maintenancePercent} suffix="%" step="1" />
                      <InputGroup label="Capital Expenditures" name="capexPercent" value={inputs.capexPercent} suffix="%" step="1" />
                      <InputGroup label="Property Management" name="managementPercent" value={inputs.managementPercent} suffix="%" step="1" />
                    </div>
                  </div>
                </div>
              </div>
